...
class AlipaydevProvider extends Base
{
    public const NAME = 'alipaydev';
    ...
    {
        return $this->buildAuthUrlFromBase('https://openauth.alipaydev.com/oauth2/publicAppAuthorize.htm');
    }
